...
final List<Category> defaultCategories = [
  Category("1", "Татвар", MdiIcons.fileDocument),
  Category("2", "Түрээс", Icons.home),
  Category("3", "Хүнс", MdiIcons.foodForkDrink),
  Category("4", "Аялал", MdiIcons.shopping),
  Category("5", "Зээл", Icons.monetization_on),
  Category("6", "Бусад", MdiIcons.cashRegister),
];
