  ...
  Future<void> _getData(User user, Function setExpenses, DateTime lastUpdate,
    ...
    if (difference.inMinutes < 10) {
      Scaffold.of(context).showSnackBar(SnackBar(
        ...
        content: Text(
            "Дараагийн шинэчлэл ${10 - difference.inMinutes} минутын хооронд."),
      ...
      Scaffold.of(context).showSnackBar(SnackBar(
        backgroundColor:
            deviceTheme == "light" ? Colors.blueAccent : Colors.blue[800],
        content: Text("Дараагийн шинэчлэл 10 минутын дараа."),
        action: SnackBarAction(
          onPressed: () {
            Scaffold.of(context).hideCurrentSnackBar();
          },
                                    ...
                                    Scaffold.of(context).showSnackBar(
                                      SnackBar(
                                        backgroundColor: deviceTheme == "light"
                                            ? Colors.blueAccent
                                            : Colors.blue[800],
                                        content: Text("Зарлага олдсонгүй."),
                                        action: SnackBarAction(
                                          onPressed: () {
                                            Scaffold.of(context)
                                                .hideCurrentSnackBar();
